  ...
  <div>
    ...
    <div>
      <p>
        ...
        　　甘当人民群众小学生，态度要端正——
        　　习近平同志在地方工作时就提出，当县委书记一定要跑遍所有的村，当市委书记一定要跑遍所有的乡镇，当省委书记一定要跑遍所有的县市区。在《干在实处
        走在前列》一书的自序中，习近平同志提到自己“坚持调研开局、调研开路，凡事眼睛向下，先当学生，不耻下问，问计于基层、问计于群众，每年至少用三分之一以上时间深入基层和部门调查研究”。
...
export default {
  mounted() {
    ...
    //     imgs.forEach(img => {
    //         if(img.getBoundingClientRect().top <script window.innerHeight) {
