...
## 图片上传
<br>
<tUploader message="只能上传jpg/png文件，且不超过500kb" :onsuccess="success" :onerror="error" @change="change" multiple acceptType="image/jpeg,image/png" :imgList="imgList"></tUploader>
